...
const Adminbonafied = () => {
  ...
  const generatePDF = () => {
    ...
    const body = `Certified that ${selectedBonafied?.fullName} ${selectedBonafied?.regNo} is bonafied student of this college and studying in ${selectedBonafied?.year}\n  B.Tech ${selectedBonafied?.department} during the academic year ${academicYear}`;
    // Tables
    const tableData = [
